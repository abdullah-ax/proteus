...
>(({ className, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-[50%] top-[50%] z-50 w-[90vw] max-w-lg translate-x-[-50%] translate-y-[-50%] rounded-2xl border border-white/20 bg-white/10 p-6 backdrop-blur data-[state=open]:animate-in data-[state=closed]:animate-out",
        className
      )}
      {...props}
    />
